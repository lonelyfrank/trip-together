...
export default function ConnectionBanner() {
  ...
  return (
    <div
      role="status"
      className="sticky inset-x-0 top-0 z-40 mx-auto flex items-center justify-center gap-2 border-b border-danger/25 bg-danger/10 px-4 py-2 text-danger-text backdrop-blur"
